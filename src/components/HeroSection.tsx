...
const HeroSection = () => {
  return <section className="pt-24 pb-16 px-6 bg-background">
        ...
        <div className="text-center space-y-8 animate-fade-up">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <p className="font-sans text-base text-muted-foreground">Valeriia Baranova</p>
              <p className="font-sans text-base text-muted-foreground">Specialist in IR/NLP & Medical AI</p>
            </div>
          </div>
